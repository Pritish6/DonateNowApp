...
import com.drivertest.donatenowapp.di.component.DaggerFragmentComponent
  ...
  private var _binding: B? = null
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((requireContext().applicationContext as AppClass).applicationComponent)
